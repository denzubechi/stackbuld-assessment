...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex md:h-10 items-center justify-center rounded-md bg-white p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
